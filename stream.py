...
#vcap168 = cv.VideoCapture("rtsp://admin:admin@192.168.1.168:554/ch01/0")
#vcap169 = cv.VideoCapture("rtsp://admin:admin@192.168.1.169:554/ch01/0")

vcap168 = VideoStream("rtsp://admin:admin@192.168.1.168:554/ch01/0").start()
vcap169 = VideoStream("rtsp://admin:admin@192.168.1.169:554/ch01/0").start()
