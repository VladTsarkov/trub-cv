...
class Lidar():
    ...
    def data_gen_dent(self, circles): # Задается ли изначально радиус трубы?
        self.angl = 0
        cnt = 0
        for i in range(circles):
    ...
    def data_gen(self,circles = 3): # Задается ли изначально радиус трубы?
        #img = create_img()
        #self.blank_img()
        cnt = 0
        #list_data = []
